...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <button className="hover:bg-orange-600 hover:text-white hover:border-orange-600 text-base duration-300 bg-black text-white hidden md:flex items-center py-2 rounded-full">
      ...
      <div
        className={
          nav
            ? "fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300 transition-all ease-linear"
            : "fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300 transition-all ease-linear"
        }
      >
        <AiOutlineClose
          onClick={() => setNav(!nav)}
